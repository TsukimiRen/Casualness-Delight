...
public class ItemTab {
    public static final ItemGroup CasualnessDelightTab = Registry.register(Registries.ITEM_GROUP,
            new Identifier(CasualnessDelightFabric.MODID, "casualness_delight"),
    ...
    public static void register() {
        CasualnessDelightFabric.LOGGER.info("Registering Item Group for " + CasualnessDelightFabric.MODID);
    }
}
